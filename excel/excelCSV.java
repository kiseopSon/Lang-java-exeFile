...
public class excelcsv{
	 ...
	 */
	void csv(String oldPath, String newPath) throws IOException, NullPointerException, Exception {
		this.Oldpath = new File(oldPath);
		this.Newpath = new File(newPath);
		
		if(oldPath.endsWith(".scv")) {
			try{
				...
				System.out.println("IOException - exceltxt.csv");
			} catch (NullPointerException e) {
				System.out.println("NullPointerException - exceltxt.csv");
			}catch (Exception e) {
				System.out.println("Exception - exceltxt.csv");
			} finally {
				Workbook.close();
